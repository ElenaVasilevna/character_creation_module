...
def defence(char_name: str, char_class: str, damage_points: int) -> str:
    """Тренинг блока."""
    if char_class == 'warrior':
        return (f'{char_name} блокировал {10 + damage_points.randint(5, 10)}'
                ' урона')
    if char_class == 'mage':
        return (f'{char_name} блокировал {10 + damage_points.randint(-2, 2)}'
                ' урона')
    if char_class == 'healer':
        return (f'{char_name} блокировал {10 + damage_points.randint(2, 5)}'
                ' урона')
